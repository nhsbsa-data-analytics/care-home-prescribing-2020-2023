...
AB is a product that is in a continual state of refinement, with updated releases on a six-weekly schedule. For each of the three financial years, the extract with date closest to the end of the financial year was used.
