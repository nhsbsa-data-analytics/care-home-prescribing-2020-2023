  ...
  tagList(
    ...
    HTML(
      tibble::tribble(
        ...
        "% of patient-months with 3+ ACAP medicines",        "Polypharmacy",    "Count of patient-months with 3+ unique ACAP medicines",                         "Count of patient-months with 1+ ACAP medicine",                 "Percentage of patient-months with anticoagulant/antiplatelet prescribing, in which at least 3 anticoagulant/antiplatelet medicines were prescribed",
