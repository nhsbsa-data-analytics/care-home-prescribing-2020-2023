mod_06_geo_ch_flag_ui <- function(id) {
  ...
  tagList(
    ...
    nhs_card(
      ...
      nhs_grid_2_col(
        highcharter::highchartOutput(
          outputId = ns("map_chart_ch"),
          height = "500px"
        ),
        highcharter::highchartOutput(
          outputId = ns("map_chart_non_ch"),
          height = "500px"
        )
      ),
      nhs_grid_2_col(
        DT::DTOutput(
          outputId = ns("map_table_ch")
        ),
        DT::DTOutput(
          outputId = ns("map_table_non_ch")
        )
      ),
      tags$text(
        class = "highcharts-caption",
      ...
      nhs_grid_2_col(
        mod_nhs_download_ui(
          id = ns("download_map_table_ch")
        ),
        mod_nhs_download_ui(
          id = ns("download_map_table_non_ch")
        )
      )
    )
  )
